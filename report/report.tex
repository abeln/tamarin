...
Internally, \textsf{Transform} consists of multiple ``mini-phases'', each of type \lstinline{Trace => Trace}, which are sequentially applied to the input. The mini-phases are described below.
